...
/// 经典Header组件
class HhHeaderWidget extends StatefulWidget {
  final HhHeader classicalHeader;
  ...
  @override
  HhHeaderWidgetState createState() => HhHeaderWidgetState();
}

class HhHeaderWidgetState extends State<HhHeaderWidget>
    with TickerProviderStateMixin<HhHeaderWidget> {
  // 是否到达触发刷新距离
  ...
  String get _infoText {
    return widget.classicalHeader.infoText ?? '更新于 %T';
  }
