...
class HhFooter extends Footer {
  ...
  HhFooter({
    ...
    this.infoColor: CXColors.titleColor_99,
  }) : super(
          extent: extent,
          triggerDistance: triggerDistance,
          float: float,
...
/// 经典Footer组件
class HhFooterWidget extends StatefulWidget {
  final HhFooter classicalFooter;
  ...
  @override
  HhFooterWidgetState createState() => HhFooterWidgetState();
}

class HhFooterWidgetState extends State<HhFooterWidget>
    with TickerProviderStateMixin<HhFooterWidget> {
  // 是否到达触发加载距离
  ...
  String get _loadText {
    return widget.classicalFooter.loadText ?? '上拉加载';
  }
  ...
  String get _noMoreText {
    return widget.classicalFooter.noMoreText ?? '没有更多内容了';
  }

  String get _infoText {
    return widget.classicalFooter.infoText ?? '更新于 %T';
  }
