...
class YGSTab extends StatelessWidget {
  ...
  Widget _buildLabelText() {
    return child ?? Text(text, softWrap: false, overflow: TextOverflow.fade,style: TextStyle(fontSize: fontsize==null?12:fontsize),);
  }
      ...
      label = Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              child: icon,
              margin: const EdgeInsets.only(bottom: 2), //Tab 图标与文字间距离
            ),
            _buildLabelText(),
          ],
        ),
...
class YGSTabBar extends StatefulWidget implements PreferredSizeWidget {
...
class _TabBarState extends State<YGSTabBar> {
  ...
  @override
  void didUpdateWidget(YGSTabBar oldWidget) {
...
///
/// To see a sample implementation, visit the [TabController] documentation.
class YGSTabBarView extends StatefulWidget {
...
class _TabBarViewState extends State<YGSTabBarView> {
  TabController _controller;
  ...
  @override
  void didUpdateWidget(YGSTabBarView oldWidget) {
    super.didUpdateWidget(oldWidget);
...
///
/// Used by [YGSTabPageSelector] to indicate the selected page.
class YGSTabPageSelectorIndicator extends StatelessWidget {
  /// Creates an indicator used by [YGSTabPageSelector].
  ///
  /// The [backgroundColor], [borderColor], and [size] parameters must not be null.
  const YGSTabPageSelectorIndicator({
    Key key,
...
/// If a [TabController] is not provided, then there must be a
/// [DefaultTabController] ancestor.
class YGSTabPageSelector extends StatelessWidget {
  /// Creates a compact widget that indicates which tab has been selected.
  YGSTabPageSelector({
    Key key,
    this.controller,
    this.indicatorSize = 12.0,
    this.indicatorSizeWidth = 12.0,
    this.color,
    this.selectedColor,
  })  : assert(indicatorSize != null && indicatorSize > 0.0),
        assert(indicatorSizeWidth != null&& indicatorSizeWidth > 0.0),
        super(key: key);
  ...
  Widget _buildTabIndicator(
    ...
    if(tabController.index != tabIndex){
      indicatorSizeWidth = indicatorSize;
    }*/
    sizeH = indicatorSize;
    sizeW = indicatorSizeWidth;
    ...
    return YGSTabPageSelectorIndicator(
      backgroundColor: background,
      borderColor: selectedColorTween.end,
      size: indicatorSize,
      sizeWidth: indicatorSizeWidth,
    );
  }
